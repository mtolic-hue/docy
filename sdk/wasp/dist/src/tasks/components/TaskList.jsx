import { deleteCompletedTasks, getTasks, useQuery, } from "wasp/client/operations";
...
export function TaskList() {
    ...
    return (<div className="flex flex-col gap-6">
      ...
      <div className="flex h-5 items-center justify-between">
        ...
        {completedTasks.length > 0 && (<Button className="flex items-center gap-2" size="sm" onClick={handleDeleteCompletedTasks}>
            Clear completed
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="size-5 fill-black">
...
//# sourceMappingURL=TaskList.jsx.map