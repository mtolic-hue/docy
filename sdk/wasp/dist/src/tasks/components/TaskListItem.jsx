...
export function TaskListItem({ task }) {
    ...
    return (<li>
      <label className={twJoin("card flex w-full flex-wrap items-center justify-between gap-4 rounded-lg px-6 py-3", task.isDone ? "bg-primary-50" : "bg-neutral-50")}>
        <div className="flex min-w-0 items-center gap-4">
          <input type="checkbox" className="h-5 w-5 shrink-0 accent-primary-500" checked={task.isDone} onChange={setTaskDone}/>
...
//# sourceMappingURL=TaskListItem.jsx.map