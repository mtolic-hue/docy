...
export function CreateTagDialog() {
    ...
    return (<>
      <Button className="flex items-center gap-2" type="button" size="sm" onClick={() => setTagDialogOpen(true)}>
        <span>Add a Tag</span>
        <span>+</span>
      </Button>
      {tagDialogOpen && (<Portal>
          <Dialog open={tagDialogOpen} onClose={() => setTagDialogOpen(false)}>
            <section className="card relative flex flex-col">
              ...
              <footer className="flex justify-end gap-2 px-4 py-6 lg:px-6 lg:py-8">
                ...
                <Button form={CREATE_TAG_FORM_ID} type="button" onClick={() => setTagDialogOpen(false)} variant="ghost">
                  Cancel
                </Button>
              </footer>
            </section>
...
//# sourceMappingURL=CreateTagDialog.jsx.map