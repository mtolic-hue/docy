...
export const ChildPage = () => {
    const { id } = useParams();
    if (!id)
        return <div className="p-4">Invalid child id</div>;
    ...
    return (<div className="flex flex-col items-center gap-8 px-8 py-12">
      ...
      <section className="card w-full max-w-3xl p-4">
        ...
        <div className="flex flex-col gap-2">
          {checks && checks.length > 0 ? (checks.map((c) => (<div key={c.id} className="p-2 border-b">
...
//# sourceMappingURL=ChildPage.jsx.map